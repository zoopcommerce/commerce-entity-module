...
//    }
    ...
    /**
     * @expectedException \Zoop\Entity\Exception\MissingParentException
     */
    public function testMissingParentException()
    {
    ...
    /**
     * @expectedException \Zoop\Entity\Exception\InvalidParentException
     */
    public function testInvalidParentException()
    {
        $entities = ['apple', 'demo'];

        $parent = $this->getMock('Zoop\\Customer\\DataModel\\Customer');
        $parent->method('getSlug')
            ->willReturn('invalid-parent');

        $store = new Store;
        $store->setSlug('apple');
        $store->setEntities(['apple', 'demo']);
        $store->setCustomer($parent);
